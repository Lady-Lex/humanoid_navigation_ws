...
if("TRUE" STREQUAL "TRUE")
  set(gridmap_2d_SOURCE_PREFIX /home/lexington2002/Workspace/humanoid_navigation_ws/src/humanoid_navigation/gridmap_2d)
  set(gridmap_2d_DEVEL_PREFIX /home/lexington2002/Workspace/humanoid_navigation_ws/devel)
  ...
  set(gridmap_2d_INSTALL_PREFIX /home/lexington2002/Workspace/humanoid_navigation_ws/install)
...
if(NOT "/home/lexington2002/Workspace/humanoid_navigation_ws/src/humanoid_navigation/gridmap_2d/include;/usr/include;/usr/include/opencv " STREQUAL " ")
  set(gridmap_2d_INCLUDE_DIRS "")
  set(_include_dirs "/home/lexington2002/Workspace/humanoid_navigation_ws/src/humanoid_navigation/gridmap_2d/include;/usr/include;/usr/include/opencv")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT gridmap_2d_NUM_DUMMY_TARGETS)
      set(gridmap_2d_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::gridmap_2d::wrapped-linker-option${gridmap_2d_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR gridmap_2d_NUM_DUMMY_TARGETS "${gridmap_2d_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::gridmap_2d::wrapped-linker-option${gridmap_2d_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND gridmap_2d_LIBRARIES "${interface_target_name}")
